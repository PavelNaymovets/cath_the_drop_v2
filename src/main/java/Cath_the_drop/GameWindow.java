...
public class GameWindow extends JFrame {
    ...
    public static void main(String[] args) throws IOException {
        ...
        gameWindow = new GameWindow(); // создаем окно
    ...
    private static void onRepaint (Graphics g){ // для возможности рисования
...
//        g.drawLine(20,20,100,20); Рисуем линию
    }

    private static class GameField extends JPanel{ // рисуем на панелях. Для этого создаем новый класс
